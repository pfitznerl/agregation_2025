...
liste_agreg<- c("BOA","results_1253_oversampling2_05_new_BOA")
    ...
    for (ista in 1:length(liste_sta)) {
        ...
        for(iech in 1:length(liste_ech)) {
            ...
            for (iagreg1 in 1:length(liste_agreg)){
                ...
                AGREG1=agreg1
                if(AGREG1=="raw.arp"|AGREG1=="mos.arp"|AGREG1=="raw.cep"|AGREG1=="mos.cep"){
                    AGREG1="BOA"
                }
                if(AGREG1=="results_1253_oversampling2_05_new_BOA") agreg1="BOA"
                ...
                for (iagreg2 in 1:length(liste_agreg)) {
                    ...
                    AGREG2=agreg2
                    if(AGREG2=="raw.arp"|AGREG2=="mos.arp"|AGREG2=="raw.cep"|AGREG2=="mos.cep"){
                        AGREG2="BOA"
                    }
                    if(AGREG2=="results_1253_oversampling2_05_new_BOA") agreg2="BOA"
                    ...
                    if (iagreg1!=iagreg2 & sum(e1-e2,na.rm=T)!=0) {
                        dm=dm.test(e1^2,e2^2,h=1,alternative="less",varestimator = "acf",power=2)$p.value
